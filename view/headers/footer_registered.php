...
<footer>
	<p><a href="index.php">Accueil </a>| <a href="<?php echo BASE_URL.'/index.php?page=news' ?>">News</a>  | <a href="<?php echo BASE_URL.'/index.php?page=comics' ?>">Comics</a> | <a href="<?php echo BASE_URL.'/index.php?page=comics&pagesec=mes_comics' ?>">Mes Comics</a>  | <a href="<?php echo BASE_URL.'/index.php?page=compte' ?>">Mon compte</a>
